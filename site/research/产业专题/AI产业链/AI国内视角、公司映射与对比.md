...
数据日期：政策与经营数据主要截至 2026 年第二季度；盘中估值字段按表内时间

> 文档版本：2026-07-15。文中的行情与估值表仍按各表标注的 2026-07-03 采集时点展示，未把历史盘中数据冒充为最新行情。
...
本节把“行业敞口”定义为公司收入、订单、客户或资本开支对某条 AI 子链的真实敏感度，不把公司名称或产品发布当成敞口证据。公开披露没有拆出 AI 收入时，会写成中低纯度并列出核验项，而不是给一个看似精确的百分比。
